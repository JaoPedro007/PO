...
public class Venda extends javax.swing.JFrame {
    ...
    public void adicionarDadosCliente(String cpf) throws SQLException {
        ...
        tf_nome_cliente.setText("testando");
    ...
    private void btn_pagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pagamentoActionPerformed
        ...
        dialogPagamento.exibirValorTotal(total);
    ...
    private void btn_clientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_clientesActionPerformed
        ...
        if (dialogCliente.clienteSelecionado == null) {
            JOptionPane.showMessageDialog(null, "Selecione um cliente", "Atenção", JOptionPane.WARNING_MESSAGE);
        }
        tf_nome_cliente.setText(dialogCliente.clienteSelecionado.getNome());
        tf_cpf_cliente.setText(dialogCliente.clienteSelecionado.getCpfcnpj());
        tf_telefone_cliente.setText(dialogCliente.clienteSelecionado.getTelefone());
    ...
    private void calcularValorTotal() {
        ...
        for (int row = 0; row < quantidadeLinhas; row++) {
            ...
            tf_total.setText(String.valueOf(soma));
