...
public class DialogCliente extends javax.swing.JDialog {
    ...
    private void btn_adicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_adicionarActionPerformed
        ...
        int column = 1;
        Object dados = tabela_dialog_cliente.getValueAt(row, column);
        String cpf = dados.toString();
        Venda venda = new Venda();
        try {
            venda.adicionarDadosCliente(cpf);
            this.dispose();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não foi possível adicionar o cliente", "Atenção", JOptionPane.ERROR_MESSAGE);
