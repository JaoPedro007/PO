...
public class Main extends javax.swing.JFrame {
    ...
    private void btn_gravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_gravarActionPerformed
        ...
        String conta = "Dados da conta" 
                ...
                + "\r\n Endereço: " + tf_endereco.getText()
                + "\r\n Bairro: " + tf_bairro.getText()
                + "\r\n CPF: " + tf_cpf.getText() 
                + "\r\n Nascimento: " + tf_nascimento.getText()
                + "\r\n Data vencimento " + tf_dataVencimento.getText() 
                + "\r\n Unidade consumidora: " + tf_unidadeConsumidora.getText()
                + "\r\n Email: " + tf_email.getText()
                + "\r\n Kwh: " + tf_kwh.getText() 
                + " Valor total: " + tf_total.getText();
                
        byte[] buff = conta.getBytes();
