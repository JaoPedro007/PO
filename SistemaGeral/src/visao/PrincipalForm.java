...
public class PrincipalForm extends javax.swing.JFrame {
   ...
   private Usuario usuario;
    ...
    private void initComponents() {
        ...
        jMenu3.setText("Cadastrar/Editar");
        ...
        jMenuItem1.setText("Clientes/Fornecedores");
        jMenu3.add(jMenuItem1);

        jMenuItem2.setText("Tabela de preço");
        jMenu3.add(jMenuItem2);

        jMenu1.add(jMenu3);

        jMenu4.setText("Reativar");
        jMenu1.add(jMenu4);
        ...
        jMenuItem6.setText("Emitir NFC-e");
     ...
     */
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
